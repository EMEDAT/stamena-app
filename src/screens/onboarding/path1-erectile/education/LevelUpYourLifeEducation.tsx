...
export default function LevelUpYourLifeEducation() {
  return (
    <SafeAreaProvider>
          ...
          <View style={styles.contentContainer}>
            ...
            <View style={styles.textContent}>
              ...
              <Text style={styles.description}>
                Stronger performance. Longer stamina. More confidence. It starts by training what most men ignore.
              </Text>
            </View>

            {/* Level Up Illustration Image */}
            <View style={styles.illustrationContainer}>
              <Image
                source={require('../../../../../assets/images/onboarding/illustrations/path-1/educational-slide/mask-group11.png')}
